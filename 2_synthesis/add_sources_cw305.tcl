...
if { [info exists ::env(CROC_ROOT)] && $::env(CROC_ROOT) ne "" } {
    ...
    set CROC [file normalize "[file dirname [info script]]/../../../croc"]
}
...
set MX_ROOT [file normalize "${CROC}/.."]
add_files -norecurse -fileset [current_fileset] [list \
    ${MX_ROOT}/fpga/cw305/src/croc_cw305.sv \
    ${MX_ROOT}/fpga/cw305/src/cw305_usb_reg_fe.sv \
]
