...
#
# Usage:
#   vivado -mode batch -source fpga/cw305_ila/scripts/build_cw305.tcl
#
# Prerequisite:
#   make setup   (creates croc/ directory with symlinks + MX files)
#
# Output:
#   fpga/cw305_ila/build/croc_cw305.bit  — bitstream for CW305 programming
#
...
# ---- Load constraints ----
import_files -fileset constrs_1 -norecurse ${project_root}/cw305.xdc
...
foreach memfile [glob -nocomplain ${project_root}/*.mem] {
...
# ---- Load RTL sources ----
source ${project_root}/add_sources.cw305.tcl
