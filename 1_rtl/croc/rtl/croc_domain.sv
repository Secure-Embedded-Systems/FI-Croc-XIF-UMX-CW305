...
module croc_domain import croc_pkg::*; #(
  ...
  parameter              SramInitFile0 = "none",
  parameter              SramInitFile1 = "none"
) (
  input  logic      clk_i,
  input  logic      rst_ni,
  ...
  // MX coprocessor scan chain (directly to FPGA pins)
  ...
  for (genvar i = 0; i < NumSramBanks; i++) begin : gen_sram_bank
    ...
    tc_sram_impl #(
      ...
      .NumPorts    (  1 ),
      .Latency     (  1 ),
      .MemInitFile ( i == 0 ? SramInitFile0 : SramInitFile1 )
    ) i_sram (
      .clk_i,
      .rst_ni,
