...
package croc_pkg;
  ...
  /// Bank 0 = IMEM (4KB), Bank 1 = DMEM (4KB), Total = 8KB
  ...
  localparam addr_map_rule_t [3:0] croc_addr_map = '{
    ...
    '{ idx: XbarBank0,   start_addr: 32'h1000_0000, end_addr: 32'h1000_1000 },  // IMEM 4KB
    '{ idx: XbarBank0+1, start_addr: 32'h1000_1000, end_addr: 32'h1000_2000 }  // DMEM 4KB
  };
